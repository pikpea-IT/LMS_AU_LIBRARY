...
@section('pagetitle')
    {{ trans('Manage Issue Book') }}
@endsection

@section('content')
@section('breadcrumb_title', trans('List Issue Book'))
@section('breadcrumb_home', trans('Home'))
@section('breadcrumb_pagename', trans('List Issue Book'))

@section('breadcrumb', trans('List Issue Book'))
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-home-tab" data-toggle="pill"
                                    ...
                                    aria-selected="false">List Book Issuse</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-four-profile-tab" data-toggle="pill"
                                    href="#custom-tabs-four-profile" role="tab"
                                    aria-controls="custom-tabs-four-profile" aria-selected="true">Add Book
                                    Issuse</a>
                            </li>
                        </ul>
                    </div>
