...
@section('pagetitle')
    {{ trans('Create Members') }}
@endsection

@section('content')
@section('breadcrumb_title', trans('Create Members'))
@section('breadcrumb_home', trans('Home'))
@section('breadcrumb_pagename', trans('Members'))

@section('breadcrumb', trans('List Member'))

<div class="row" x-data='{data_record : @json(old())}'>
    {{-- check if can create --}}
    @include('admin.clubmember.crud')
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0 text-primary">
                    <i class="bx bxs-user me-1 font-22 text-primary"></i> Members
                </h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    @include('admin.clubmember.list')
                </div>
            </div>
        </div>
    </div>
