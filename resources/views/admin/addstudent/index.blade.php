...
@section('content')
@section('breadcrumb_title', trans('Create Students'))
@section('breadcrumb_home', trans('Home'))
@section('breadcrumb_pagename', trans('Students'))

@section('breadcrumb', trans('Create Students'))
