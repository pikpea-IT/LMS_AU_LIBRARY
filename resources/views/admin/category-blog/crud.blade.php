      ...
      <div class="col-md-4 mb-2">
        <div class="card">
          <div class="card-body">
            ...
            <form id="my-form" action="{{ route('admin.category-blogs.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="slug form-control" :value="data_record.slug" name="slug" id="slug">
              </div>
              ...
              <div class="form-group">
                ...
                <div class="position-relative border rounded" style=" background: #e7e7e7b0; ">
                  ...
                  <input type="hidden" name="image_url" value="{{ old('image_url') }}" :value="data_record.image">
              ...
              <div class="d-grid gap-2">
                ...
                <input class="btn btn-danger btn-block mt-2 d-none" id="cancel-btn" type="button" value={{ __('cancel') }}
                  onclick="cancel()">
              </div>
            </form>
          </div>
