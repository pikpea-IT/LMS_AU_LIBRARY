...
@push('styles')
  ...
  <link href="{{asset('assets')}}/backend/plugins/icheck-bootstrap/icheck-bootstrap.min.css" rel="stylesheet">
  <link href="{{asset('assets')}}/backend/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet">
  <link href="{{asset('assets')}}/backend/plugins/datatables-responsive/css/responsive.bootstrap4.min.css"
    rel="stylesheet">
  <link href="{{asset('assets')}}/backend/plugins/datatables-buttons/css/buttons.bootstrap4.min.css" rel="stylesheet">
  <link href="{{asset('assets')}}/backend/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css"
    rel="stylesheet">
