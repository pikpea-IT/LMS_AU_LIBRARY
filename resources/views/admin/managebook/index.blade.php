...
@section('content')
@section('breadcrumb_title', trans('Manage Books'))
@section('breadcrumb_home', trans('Home'))
@section('breadcrumb_pagename', trans('Manage Books'))

@section('breadcrumb', trans('Manage Books'))
