...
<link href="{{asset('assets')}}/backend/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css" rel="stylesheet" />
@endpush
...
<link rel="stylesheet" href="{{asset('assets')}}/backend/dist/css/toggle.css">
...
@section('content')
@section('breadcrumb', trans('cruds.book.title'))
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="datatable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>{{ trans('cruds.book.fields.id') }}</th>
                        <th>{{ trans('cruds.book.fields.group') }}</th>
                        <th>{{ trans('cruds.book.fields.title') }}</th>
                        <th>{{ trans('cruds.book.fields.created_at') }}</th>
...
@include('admin.book.templates.crudModal')
@endsection
    ...
    $('body').on('click', 'a#objectEdit', function(e) {
        ...
        $.get(actionUrl + '/' + object_id + '/edit', function(res) {
            ...
            if (res.data.status == 1) {
                ...
                form.find('#book_status').prop('checked', false);
            }
            modal.modal('show');
        })
    });
